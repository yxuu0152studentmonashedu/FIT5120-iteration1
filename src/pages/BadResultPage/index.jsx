          ...
          <div className="absolute bottom-[0] flex flex-col inset-x-[0] justify-start mx-[auto] pr-[122px] sm:pr-[20px] md:pr-[40px] py-[122px] w-[100%]">
            ...
            <div className="font-dmsans h-[500px] md:h-[576px] mr-[294px] mt-[76px] relative md:w-[100%] w-[81%]">
              ...
              <div className="absolute bg-gradient1  bottom-[36%] flex md:flex-col flex-row gap-[48px] items-center justify-center p-[23px] sm:px-[20px] right-[0] rounded-[15px] w-[58%]">
                ...
                <Text
                  className="common-pointer mr-[492px] not-italic text-left text-white_A700 w-[auto]"
                  as="h6"
                  variant="h6"
            ...
            <div className="bg-white_A700 border-[2px] border-deep_purple_900 border-solid flex flex-col font-sourcesanspro gap-[48px] items-center justify-start mb-[56px] md:ml-[0] ml-[664px] mr-[549px] mt-[139px] pb-[148px] rounded-[24px] shadow-bs1 md:w-[100%] w-[22%]">
              <div className="md:h-[64px] h-[73px] relative w-[100%]">
                <div className="absolute bg-red_301 flex inset-x-[0] items-start justify-end mx-[auto] p-[9px] top-[0] w-[100%]">
                  <Text
                ...
                <div className="absolute bg-red_302 border-[6px] border-red_303 border-solid bottom-[0] flex h-[64px] items-center justify-start p-[8px] right-[10%] rounded-[50%] w-[64px]">
                  <div className="bg-red_700 flex h-[48px] items-center justify-start p-[12px] rounded-[50%] w-[48px]">
                    <div className="flex h-[24px] items-center justify-start w-[24px]">
                      <Img
                        src="images/img_interfacedelete.png"
              ...
              <div className="flex font-hind items-start justify-start w-[260px]">
                <Text
                  ...
                  variant="body2"
                >
                  The link you enter is not safety.
                </Text>
              </div>
            </div>
          </div>
...
export default BadResultPagePage;
